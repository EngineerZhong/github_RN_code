...
import {onLoadTrendingData,onLoadMoreTrending} from '../action/trending/index';
...
export default class TrendingPage extends Component {
    ...
    constructor(props) {
        super(props);
        this.tabNames = ['All', 'Android', 'Java', 'ReactNative', 'Flutter'];
    }
    ...
    _genTabs() {
        ...
        this
            ...
            .forEach((item, index) => {
                tabs[`tab${index}`] = {
                    screen: props => {
                        return <TrendingTabPage {...props} tabLabel={item}/>
                    },
                    navigationOptions: {
                        title: item
                    }
...
const TrendingTabPage = connect(mapStateToProps, mapDispatchToProps)(TrendTab)
